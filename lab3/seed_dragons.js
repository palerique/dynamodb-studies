...
function pushToDragonStatsTableOne() {
    let dragon = {};
    const dragon_formatted_arr = [];
    let params = {};

    const DRAGON_DATA_ARR = require("../lab3/resources/dragon_stats_one.json");

    for (let i_int = 0; i_int < DRAGON_DATA_ARR.length; i_int += 1) {
        dragon = {
            PutRequest: {
                Item: {
                    damage: {
...
function pushToDragonStatsTableTwo() {
    ...
    const DRAGON_DATA_ARR = require("../lab3/resources/dragon_stats_two.json");
...
function pushToDragonCurrentPowerTable() {
    ...
    const DRAGON_DATA_ARR = require("../lab3/resources/dragon_current_power.json");
...
function pushToDragonBonusAttackTable() {
    ...
    const DRAGON_DATA_ARR = require("../lab3/resources/dragon_bonus_attack.json");
...
function pushToDragonFamilyTable() {
    ...
    const DRAGON_DATA_ARR = require("../lab3/resources/dragon_family.json");

    for (let i_int = 0; i_int < DRAGON_DATA_ARR.length; i_int += 1) {
        console.log(DRAGON_DATA_ARR[i_int]);
        console.log(DRAGON_DATA_ARR[i_int].damage_modifer_int);
        dragon = {
            PutRequest: {
                Item: {
                    breath_attack: {
